...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::codex::get_openclaw_model_settings,
            commands::codex::save_openclaw_model_settings,
            commands::codex::openclaw_wechat_bind,
            commands::codex::test_openclaw_wechat_notification,
